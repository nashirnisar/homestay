...
export const DeluxeRoom: React.FC = () => {
  ...
  const images = [
    "https://amorgoshotel.com/wp-content/uploads/2014/12/Amorgos-Superior-Room1-e1464286461356.jpg",
    "https://amorgoshotel.com/wp-content/uploads/2014/12/Amorgos-Superior-Room2-e1464286472974.jpg",
  ];
        ...
        <div className="flex flex-col justify-between w-full lg:w-1/2 h-auto p-4 bg-gray-50 rounded-lg">
          <div>
            ...
            <p className="text-gray-700 mb-4">
              The Deluxe Room offers enhanced comfort and space, ideal for
              guests seeking a premium experience. With the option of one double
              or two double beds, along with an attached bathroom, perfect for
              couple with kids, it ensures a comfortable and private stay.
            </p>
          </div>
          <Button
      ...
      <div className="w-full mt-6 p-4 bg-gray-100 rounded-lg">
        ...
        <ul className="text-gray-700 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-1">
          <li className="flex items-center">
            <FaBed className="mr-2" /> 1 Double or 2 Double Beds
          </li>
          <li className="flex items-center">
